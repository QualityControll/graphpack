...
impl GraphType for i8 {
    fn scalar_type() -> ScalarType {
        ScalarType::I8
    }
}
impl GraphType for u8 {
    fn scalar_type() -> ScalarType {
        ScalarType::U8
    }
}
impl GraphType for i16 {
    fn scalar_type() -> ScalarType {
        ScalarType::I16
    }
}
impl GraphType for u16 {
    fn scalar_type() -> ScalarType {
        ScalarType::U16
    }
}
...
impl Op {
    pub(crate) fn new(kind: OpKind, inputs: Vec<NodeId>) -> Self {
        Self { kind, inputs }
    }
