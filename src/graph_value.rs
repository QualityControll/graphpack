...
impl GraphValue<bool> {
    pub fn and(&self, rhs: GraphValue<bool>) -> GraphValue<bool> {
        binary_op(self.clone(), rhs, OpKind::LogicalAnd)
    }
    pub fn or(&self, rhs: GraphValue<bool>) -> GraphValue<bool> {
        binary_op(self.clone(), rhs, OpKind::LogicalOr)
    }
...
impl GraphValue<Complex<f32>> {
    pub fn eq_scalar(&self, rhs: Complex<f32>) -> GraphValue<bool> {
        comparison(self.clone(), constant(rhs), OpKind::Equal)
    }
    pub fn ne_scalar(&self, rhs: Complex<f32>) -> GraphValue<bool> {
        comparison(self.clone(), constant(rhs), OpKind::NotEqual)
    }
}
...
impl GraphValue<String> {
    pub fn eq_scalar(&self, rhs: &str) -> GraphValue<bool> {
        comparison(self.clone(), constant(rhs.to_string()), OpKind::Equal)
    }
    pub fn ne_scalar(&self, rhs: &str) -> GraphValue<bool> {
        comparison(self.clone(), constant(rhs.to_string()), OpKind::NotEqual)
    }
}
impl<T> Add for GraphValue<T> {
    type Output = GraphValue<T>;
    fn add(self, rhs: Self) -> Self::Output {
        binary_op(self, rhs, OpKind::Add)
    }
}
impl<T> Sub for GraphValue<T> {
    type Output = GraphValue<T>;
    fn sub(self, rhs: Self) -> Self::Output {
        binary_op(self, rhs, OpKind::Sub)
    }
}
impl<T> Mul for GraphValue<T> {
    type Output = GraphValue<T>;
    fn mul(self, rhs: Self) -> Self::Output {
        binary_op(self, rhs, OpKind::Mul)
    }
}
impl<T> Div for GraphValue<T> {
    type Output = GraphValue<T>;
    fn div(self, rhs: Self) -> Self::Output {
        binary_op(self, rhs, OpKind::Div)
    }
}
impl<T> Neg for GraphValue<T> {
    type Output = GraphValue<T>;
    fn neg(self) -> Self::Output {
        unary_op(self, OpKind::Neg)
    }
}
...
macro_rules! impl_bitwise_ops { ($($t:ty),+) => { $( impl BitAnd for GraphValue<$t>{type Output=GraphValue<$t>;fn bitand(self,rhs:Self)->Self::Output{binary_op(self,rhs,OpKind::BitAnd)}} impl BitOr for GraphValue<$t>{type Output=GraphValue<$t>;fn bitor(self,rhs:Self)->Self::Output{binary_op(self,rhs,OpKind::BitOr)}} impl BitXor for GraphValue<$t>{type Output=GraphValue<$t>;fn bitxor(self,rhs:Self)->Self::Output{binary_op(self,rhs,OpKind::BitXor)}} impl Not for GraphValue<$t>{type Output=GraphValue<$t>;fn not(self)->Self::Output{unary_op(self,OpKind::BitwiseNot)}} impl BitAnd<$t> for GraphValue<$t>{type Output=GraphValue<$t>;fn bitand(self,rhs:$t)->Self::Output{binary_op(self,constant(rhs),OpKind::BitAnd)}} impl BitOr<$t> for GraphValue<$t>{type Output=GraphValue<$t>;fn bitor(self,rhs:$t)->Self::Output{binary_op(self,constant(rhs),OpKind::BitOr)}} impl BitXor<$t> for GraphValue<$t>{type Output=GraphValue<$t>;fn bitxor(self,rhs:$t)->Self::Output{binary_op(self,constant(rhs),OpKind::BitXor)}} )+ }; }
impl_bitwise_ops!(i32, i64);
impl Shl<u32> for GraphValue<i32> {
    type Output = GraphValue<i32>;
    fn shl(self, rhs: u32) -> Self::Output {
        binary_op(self, constant(rhs as i32), OpKind::Shl)
    }
}
impl Shr<u32> for GraphValue<i32> {
    type Output = GraphValue<i32>;
    fn shr(self, rhs: u32) -> Self::Output {
        binary_op(self, constant(rhs as i32), OpKind::Shr)
    }
}
impl Shl<u32> for GraphValue<i64> {
    type Output = GraphValue<i64>;
    fn shl(self, rhs: u32) -> Self::Output {
        binary_op(self, constant(rhs as i64), OpKind::Shl)
    }
}
impl Shr<u32> for GraphValue<i64> {
    type Output = GraphValue<i64>;
    fn shr(self, rhs: u32) -> Self::Output {
        binary_op(self, constant(rhs as i64), OpKind::Shr)
    }
}