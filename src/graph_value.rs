        ...
        $(
            impl GraphValue<$t> {
                ...
                pub fn lt_scalar(&self, rhs: $t) -> GraphValue<bool> {
                    comparison(self.clone(), constant(rhs), OpKind::Less)
                }

                pub fn le_scalar(&self, rhs: $t) -> GraphValue<bool> {
                    comparison(self.clone(), constant(rhs), OpKind::LessEqual)
                }

                pub fn gt_scalar(&self, rhs: $t) -> GraphValue<bool> {
                    comparison(self.clone(), constant(rhs), OpKind::Greater)
                }

                pub fn ge_scalar(&self, rhs: $t) -> GraphValue<bool> {
                    comparison(self.clone(), constant(rhs), OpKind::GreaterEqual)
                }
            }
        )+
    };
        ...
        $(
            impl Add<$t> for GraphValue<$t> {
                ...
                fn add(self, rhs: $t) -> Self::Output {
                    binary_op(self, constant(rhs), OpKind::Add)
                }
            }
            ...
            impl Sub<$t> for GraphValue<$t> {
                ...
                fn sub(self, rhs: $t) -> Self::Output {
                    binary_op(self, constant(rhs), OpKind::Sub)
                }
            }
            ...
            impl Mul<$t> for GraphValue<$t> {
                ...
                fn mul(self, rhs: $t) -> Self::Output {
                    binary_op(self, constant(rhs), OpKind::Mul)
                }
            }
            ...
            impl Div<$t> for GraphValue<$t> {
                ...
                fn div(self, rhs: $t) -> Self::Output {
                    binary_op(self, constant(rhs), OpKind::Div)
                }
            }
        )+
    };
        ...
        $(
            impl BitAnd for GraphValue<$t> {
                ...
                fn bitand(self, rhs: Self) -> Self::Output {
                    binary_op(self, rhs, OpKind::BitAnd)
                }
            }
            ...
            impl BitOr for GraphValue<$t> {
                ...
                fn bitor(self, rhs: Self) -> Self::Output {
                    binary_op(self, rhs, OpKind::BitOr)
                }
            }
            ...
            impl BitXor for GraphValue<$t> {
                ...
                fn bitxor(self, rhs: Self) -> Self::Output {
                    binary_op(self, rhs, OpKind::BitXor)
                }
            }
            ...
            impl Not for GraphValue<$t> {
                ...
                fn not(self) -> Self::Output {
                    unary_op(self, OpKind::BitwiseNot)
                }
            }
            ...
            impl BitAnd<$t> for GraphValue<$t> {
                ...
                fn bitand(self, rhs: $t) -> Self::Output {
                    binary_op(self, constant(rhs), OpKind::BitAnd)
                }
            }
            ...
            impl BitOr<$t> for GraphValue<$t> {
                ...
                fn bitor(self, rhs: $t) -> Self::Output {
                    binary_op(self, constant(rhs), OpKind::BitOr)
                }
            }
            ...
            impl BitXor<$t> for GraphValue<$t> {
                ...
                fn bitxor(self, rhs: $t) -> Self::Output {
                    binary_op(self, constant(rhs), OpKind::BitXor)
                }
            }
        )+
    };
