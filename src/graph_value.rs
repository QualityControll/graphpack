...
pub struct GraphValue<T> { pub(crate) op: Rc<Op>, pub(crate) _marker: PhantomData<T> }
impl<T> Clone for GraphValue<T> { fn clone(&self) -> Self { Self { op: self.op.clone(), _marker: PhantomData } } }
impl<T> GraphValue<T> {
...
impl IntoConstant for f32 { fn into_constant(self)->ConstantValue{ConstantValue::F32(self)} } impl IntoConstant for f64 { fn into_constant(self)->ConstantValue{ConstantValue::F64(self)} } impl IntoConstant for i32 { fn into_constant(self)->ConstantValue{ConstantValue::I32(self)} } impl IntoConstant for i64 { fn into_constant(self)->ConstantValue{ConstantValue::I64(self)} } impl IntoConstant for usize { fn into_constant(self)->ConstantValue{ConstantValue::I64(self as i64)} } impl IntoConstant for bool { fn into_constant(self)->ConstantValue{ConstantValue::Bool(self)} }
...
impl Shl<u32> for GraphValue<i32>{type Output=GraphValue<i32>;fn shl(self,rhs:u32)->Self::Output{binary_op(self,constant(rhs as i32),OpKind::Shl)}} impl Shr<u32> for GraphValue<i32>{type Output=GraphValue<i32>;fn shr(self,rhs:u32)->Self::Output{binary_op(self,constant(rhs as i32),OpKind::Shr)}} impl Shl<u32> for GraphValue<i64>{type Output=GraphValue<i64>;fn shl(self,rhs:u32)->Self::Output{binary_op(self,constant(rhs as i64),OpKind::Shl)}} impl Shr<u32> for GraphValue<i64>{type Output=GraphValue<i64>;fn shr(self,rhs:u32)->Self::Output{binary_op(self,constant(rhs as i64),OpKind::Shr)}}
