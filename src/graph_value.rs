...
macro_rules! impl_comparison_ops {
    ($($t:ty),+) => { $(
        impl GraphValue<$t> {
            pub fn eq_scalar(self, rhs: $t) -> GraphValue<bool> { comparison(self, constant(rhs), OpKind::Equal) }
            pub fn ne_scalar(self, rhs: $t) -> GraphValue<bool> { comparison(self, constant(rhs), OpKind::NotEqual) }
            pub fn lt_scalar(self, rhs: $t) -> GraphValue<bool> { comparison(self, constant(rhs), OpKind::Less) }
            pub fn le_scalar(self, rhs: $t) -> GraphValue<bool> { comparison(self, constant(rhs), OpKind::LessEqual) }
            pub fn gt_scalar(self, rhs: $t) -> GraphValue<bool> { comparison(self, constant(rhs), OpKind::Greater) }
            pub fn ge_scalar(self, rhs: $t) -> GraphValue<bool> { comparison(self, constant(rhs), OpKind::GreaterEqual) }
        }
    )+ };
}
